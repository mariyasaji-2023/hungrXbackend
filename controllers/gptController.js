...
const chat = async (req, res) => {
    try {
        ...
        Stage 1: [step_name with emoji] - [description] - [time in seconds]
        Stage 2: [step_name with emoji] - [description] - [time in seconds]
        ...
        {
          "recipe_name": "",
          "stages": [{"step_name": "", "description": "", "time_seconds": 0}],
